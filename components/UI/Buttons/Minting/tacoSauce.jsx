...
import abi from "../../../../utils/newAbis/sauceabi"
...
async function sauceMintSetup() {

    const add = contractAdds.sauce;
...
export default function SauceMint() {
    ...
    return (
        <>
            {!paused && <button onClick={() => { isConnected && setAmountBoxShow(true) }} className=" absolute bg-transparent z-10 w-screen h-screen"></button>}
