        ...
        case 0:
          for (let i = 0; i < holding.length; i++) {
            ...
            if (stakeType == 0) {
              ...
              const img = "https://gateway.pinata.cloud/ipfs/bafybeiduqtzpwdc6hwwwjg3rt35twynjwsq367wo5phobkb3iogmhincge/" + holding[i].tokenId + ".png";
        ...
        case 1:
          for (let i = 0; i < holding.length; i++) {
            ...
            if (stakeType == 0) {
              ...
              const img = "https://gateway.pinata.cloud/ipfs/bafybeife2zu3n76ktqtn7myxpm2pfd3uhsxpxbg2gkaen2bssdh3rr47ly/" + holding[i].tokenId + ".png";
              const tokenId = holding[i].tokenId;
              dispArr.push({ name, tokenId, img, tacoType })
            }
          }
        ...
        case 3:
          for (let i = 0; i < holding.length; i++) {
            ...
            if (stakeType == 0) {
              ...
              const img = "https://gateway.pinata.cloud/ipfs/bafybeib2rme47vsbkaroqwuqidhswujjztevjhrc3ac6tg5ywwshhmfiya/" + holding[i].tokenId + ".png";
              const tokenId = holding[i].tokenId;
              dispArr.push({ name, tokenId, img, tacoType })
            }
          }
        ...
        case 5:
          for (let i = 0; i < holding.length; i++) {
            ...
            if (stakeType == 0) {
              ...
              const img = "https://gateway.pinata.cloud/ipfs/bafybeiangojvxwyo7rcxtofmcetd2rj2jlchyscbyaqcciiwcazc5qrlwm/" + holding[i].tokenId + ".png";
              const tokenId = holding[i].tokenId;
              dispArr.push({ name, tokenId, img, tacoType })
            }
          }
        ...
        case 4:
          for (let i = 0; i < holding.length; i++) {
            ...
            if (stakeType == 0) {
              ...
              const img = "https://gateway.pinata.cloud/ipfs/bafybeifgtr33q3k6t5b45gyp3hxloselihxqqj3qo4pamhyzpen54qizni/" + holding[i].tokenId + ".png";
              const tokenId = holding[i].tokenId;
              dispArr.push({ name, tokenId, img, tacoType })
            }
          }
        ...
        case 6:
          for (let i = 0; i < holding.length; i++) {
            ...
            if (stakeType == 0) {
              ...
              const img = "https://gateway.pinata.cloud/ipfs/bafybeig5rzdjulqlq3j2ei2cg6edm5jrs36blz6hxyqr6ugfhz7x2yv4ve/" + holding[i].tokenId + ".png";
              const tokenId = holding[i].tokenId;
              dispArr.push({ name, tokenId, img, tacoType })
            }
          }
        ...
        case 7:
          for (let i = 0; i < holding.length; i++) {
            ...
            if (stakeType == 0) {
              ...
              const img = "https://gateway.pinata.cloud/ipfs/bafybeiaglnj726cekyeqp3lf3rkj5pltcymo2irlcgvpa7p75lqg5zxhe4/" + holding[i].tokenId + ".png";
              const tokenId = holding[i].tokenId;
          ...
          for (let i = 0; i < holding.length; i++) {
            ...
            if (stakeType == 0) {
              ...
              const img = "https://gateway.pinata.cloud/ipfs/bafybeia5y4zjnprhj4y65kf6cncncatbq57hyxr27ssn2ya7h3ykmcozqq/" + holding[i].tokenId + ".png";
              const tokenId = holding[i].tokenId;
