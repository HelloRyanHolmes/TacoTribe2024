...
export default function PixelTaco() {
  ...
  return (
    <>
      ...
      <a href="https://opensea.io/collection/pixeltacotribe" target="_blank" className="text-2xl z-[2000] absolute bottom-4 left-4 md:hidden rounded-full bg-white p-[1px]">
