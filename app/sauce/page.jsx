...
import bg from '../../assets/sauceDisconnect.png'
import bgConnected from '../../assets/taco_sauce_bg.png'
import bgMobile from "../../assets/sauceMobDisconnected.png"
import bgMobileConnected from "../../assets/sauceMobConnected.png"
    ...
    <>
      ...
      <div className="absolute top-0 left-0 w-screen h-screen z-0 md:block max-h-screen overflow-hidden">
        ...
        <div className="relative h-full">
          ...
          {isConnected && isClient && <Image width={1920} height={1080} src={bgConnected} className="object-fit max-sm:hidden w-full h-full scale-110" />}
